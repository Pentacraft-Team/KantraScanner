...
@OnlyIn(Dist.CLIENT)
public class BlockAddScreen extends Screen {
    ...
    public BlockAddScreen(Block block) {
        super(Component.literal("Добавить блок"));
        this.block = block;
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(Component.literal("Отмена"), button -> {
                    onClose();
                })
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        float scale = 2.5f; // увеличиваем иконку в 2 раза
        ...
        int maxTextWidth = (int) (iconSize * 2.5); // ширина, под которую надо вписаться
    ...
    public void saveChanges() {
        String hexColor = String.format("%02x%02x%02x", red, green, blue);
        blocksMap.put(block, true);
        blocksColor.put(block, hexColor);
    }
}
